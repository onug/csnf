...
const Setup = () => {
    ...
    const [dependencyApps, setDependencyApps] = useState([{'Present': 0, 'App': 'Splunk_TA_aws'}, {'Present':0, 'App': 'splunk-cloud-addon-for-oci-oracle-cloud-infrastructure_103'}, {'Present':0, 'App': 'splunk-addon-for-oracle-cloud-infrastructure-oci_233'}, {'Present':0, 'App': 'Splunk_TA_MS_Security'}]);

    // the app we want to check against
    let dependency = ['Splunk_TA_aws', 'splunk-cloud-addon-for-oci-oracle-cloud-infrastructure_103', 'splunk-addon-for-oracle-cloud-infrastructure-oci_233', 'Splunk_TA_MS_Security']
        ...
        for (let appItem=0; appItem < dependency.length; appItem++){
            if (appsList.includes(dependency[appItem])) {
                ...
                if (appItem == dependency.length-1){
                    ...
                    const allPresent = present.some(item => item === 1);
                    console.log("here");
                    console.log(present);
                    if (allPresent){
                ...
                console.log('Download remaining prerequisite add-ons');
            }
        }
                ...
                <div>
                    ...
                    <div className="left">
                        ...
                        <List>
                            ...
                            <List.Item>
                            <Link to="https://splunkbase.splunk.com/app/5222">
                                Splunk Addon for Oracle Cloud Infrastructure (OCI)
                            </Link>
                            </List.Item>
                            <List.Item>
                            <Link to="https://splunkbase.splunk.com/app/7021">
