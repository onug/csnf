...
import {Dispatchers, DispatcherManager} from "../dispatchers";

const DICTIONARY_NAME = 'oracle-cloud-guard';
const DISPATCHERS = [Dispatchers.ALL];

export default class OracleCloudGuardReceiver extends BaseReceiver {
